      ...
      <section className="relative">
        <div className="relative w-screen h-[80vh]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            ...
            Empower Your Financial Future           </h1>
            <h2 className="text-white text-xs md:text-xl max-w-2xl mb-8">
            Your financial goals deserve a clear path and a trusted partner. We provide personalized strategies and expert guidance to help you make informed decisions with confidence and ease
            </h2>
            <div className="flex gap-4">
              <a href="#inquiry-form">
                <button className="bg-white  border border-white  px-6 py-2 rounded hover:bg-white/70 hover:text-black transition">
                  Contact Us
                </button>
              </a>
            </div>
      ...
      <section className="mt-32 md:ml-[10%] px-6 md:px-16  flex flex-col md:flex-row items-center justify-evenly ">
        <div className="text-center mb-10 ">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            At Kwiss, we are dedicated to helping individuals understand and
            grow their financial knowledge. With engaging content and
            expert-backed advice, we bring financial clarity to your life.
          </p>
        </div>
      ...
      <section className="py-20 bg-gray-100 mt-22">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-sm px-4 md:px-0 md:text-lg max-w-2xl mx-auto">
            We offer a variety of services to help you manage your finances.
            Explore our expertise in investment, tax planning, budgeting, and
            more.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className="bg-white p-8 rounded-lg shadow-lg w-72 hover:shadow-2xl transition-all duration-300">
            ...
            <p className="text-gray-600">
              Grow your wealth with expert advice on investments and portfolio
              management.
            </p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-400 to-teal-500">
        <div className="text-center mb-6">
          ...
          <p className="text-lg text-white max-w-lg mx-auto">
            Invite friends, earn rewards for every successful sign-up and
            purchase. Start referring today!
          </p>
        </div>
        ...
        <div className="text-center w-full bg-white rounded-lg p-6 shadow-lg mx-auto max-w-sm">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Share your referral link with friends. When they sign up and buy,
            you earn a reward!
          </p>
      ...
      <section className="py-20 bg-gray-100">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Get insights and updates from our team of experts. Check out the
            latest posts from our owners.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-500 mb-6">
                A deep dive into the future of financial systems and how
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-500 mb-6">
                Explore effective investment strategies that yield higher
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-500 mb-6">
                Learn how to plan for taxes more effectively to save and invest
      ...
      <section className="py-20 bg-gray-50">
        <div className="text-center mb-12">
          ...
          <p className=" text-gray-600 max-w-2xl mx-auto text-sm px-4 md:px-0 md:text-lg">
            We are here to help! Fill out the form below to send us your
